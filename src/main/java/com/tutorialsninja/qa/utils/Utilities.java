...
public class Utilities {
	...
	public static String generateTimeStamp() {
		...
		return "monu"+timestamp+"@gmail.com";
	}	
	...
	public static String captureScreenshot(WebDriver driver, String testName) {
		...
		String destinationScreenshotPath = System.getProperty("user.dir")+"\\Screenshots\\"+Utilities.generateTimeStamp()+testName+".png";
		try {
...
public class ReadingDataFromExcel {
	...
	public static void main(String[] args) throws IOException {
		FileInputStream file= new FileInputStream("C:\\Users\\acer\\Documents\\data3.xlsx");
		XSSFWorkbook workbook= new XSSFWorkbook(file);
		XSSFSheet sheet = workbook.getSheet("Sheet1"); //proving sheet name
		//XSSFSheet sheet = workbook.getSheetAt(0); //proving sheet index number
